...
class BookingAdminNotificationMail extends Mailable implements ShouldQueue
{
     ...
     */
    public function __construct(public Booking $booking, public Departure $departure) {}
    ...
    {
        // return new Envelope(
        //     subject: 'Booking Admin Notification Mail',
    ...
    public function content(): Content
    {
        return new Content(
            ...
            with: ['booking' => $this->booking, 'departure' => $this->departure],
        );
    }

...
namespace App\Filament\Resources\CustomDepartures\Schemas;
        ...
        return $schema
            ->components([
                ...
                Section::make('Requester Details')
                    ->description('Contact information submitted with the custom departure request.')
                    ->relationship('customDetail') // binds to the hasOne relation
                    ->columnSpanFull()
                    ->schema([
                        ...
                        Textarea::make('remarks')
                            ...
                            ->maxLength(1000)
                            ->placeholder('e.g. Vegetarian meals, slower pace…')
                            ->columnSpanFull(),
                    ]),
